...
void pico_init()
{
    ...
    // rationale; core 1 repeats the call at the top of core1_main). The FX
    // chain's reverb/delay/chorus/phaser feedback states have no denormal
    // guard of their own; mdaEPiano is only partly self-protected.
    pico_fpu_ftz_enable();
    ...
    // a sustained full-polyphony soak as pass criterion, then keep one 50 mV
    // step of margin. Lower voltage means less die heating and slower aging.
