 ...
 */
/*
 * PORTED FOR PicoFaceOB (RP2350): 2 unsuffixed floating point literals
...
class SawOsc
{
  ...
  public:
    ...
    inline float getValue(float x) { return delay.feedReturn(x - 0.5f); }

    inline float getValueFast(float x) { return x - 0.5f; }
