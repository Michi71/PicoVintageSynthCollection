...
| [`d5_extract/`](d5_extract/README.md) | D5 (planned) | D-50 ROM identification and PCM decoding: LA log-format decode, name table, acoustic page classification, and the anchored search for the sample table. Needs a ROM set, which is not in this repository. |
